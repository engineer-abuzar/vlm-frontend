...
const fetchClasses = async () => {
  return {
    ...
    upcoming: [
      { id: 1, teacher: "Prof. Patel", topic: "Chemical Bonding (CBSE 12th Board)", time: "11:30 AM", date: "Today", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Patel" },
      { id: 2, teacher: "Mrs. Iyer", topic: "English Essay Writing & Advanced Editing", time: "2:00 PM", date: "Tomorrow", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Iyer" },
      { id: 3, teacher: "Mr. Singh", topic: "Data Interpretation: Tricks & Short-cuts", time: "5:00 PM", date: "Next Week", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Singh" },
    ]
  };
};
